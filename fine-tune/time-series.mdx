---
title: "Fine-tuning IBM Granite Time Series"
...
A complete notebook for fine-tuning a Granite-TimeSeries TTM model on bike
sharing data can be found
[here](https://github.com/ibm-granite-community/granite-timeseries-cookbook/blob/main/recipes/Time_Series/Bike_Sharing_Finetuning_with_Exogenous.ipynb).