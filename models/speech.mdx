...
description: 'Get started with Granite Speech models today.'
icon: 'microphone'
---

Granite speech is a compact and efficient speech-language model, built on top of IBM's Granite language model and specifically designed for English automatic speech recognition (ASR).
...
1. [Examples](#examples)
   1. [Granite Speech with transformers](#granite-speech-with-transformers)
