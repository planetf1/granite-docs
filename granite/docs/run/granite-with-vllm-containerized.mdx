...
To run vllm with the Granite models and enabling capabilities such as tool calling, use the additional parameters specified in the vLLM documentation [here](https://docs.vllm.ai/en/v0.9.2/features/tool_calling.html?h=#ibm-granite) as part of the `docker run` command share in Section 2. 
