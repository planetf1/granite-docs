...
<img
  src="/granite/docs/images/lmstudio/granite-lm-studio-step1.jpg"
...
will be displayed. In this guide, we will select and download the Granite 3.1 8B
model. Please note that this is a large file, so the download may take some time
to complete.

<img
  src="/granite/docs/images/lmstudio/granite-lm-studio-step2.jpg"
  alt="Granite LM Studio step 2"
/>

## Step 3: Load the model and start prompting

After the download is complete, load the Granite 3.1 8B model in LM Studio. You
can now begin using the model by entering your prompts and exploring its
capabilities!

<img
  src="/granite/docs/images/lmstudio/granite-lm-studio-step3.jpg"
  alt="Granite LM Studio step 3"
/>
<img
  src="/granite/docs/images/lmstudio/granite-lm-studio-step4.jpg"
...
<img
  src="/granite/docs/images/lmstudio/granite-lm-studio-step5.jpg"
