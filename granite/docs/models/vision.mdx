...
description: "Multimodal models for enterprise document understanding: chart and table extraction, key-value pair parsing, and multimodal embedding for visual RAG pipelines."
