...
import smallPng from '../images/granite-images/small.png';
  ...
  <tbody>
    ...
    <tr>
      <td style={{ lineHeight: "1.2" }}>
        Granite-4.0-H-Small <img src={smallPng} alt="Granite H Small" width="50"/>
      </td>
    ...
    <tr>
      <td style={{ lineHeight: "1.2" }}>
         Granite-4.0-H-Tiny <img src={smallPng} alt="Granite H Tiny" width="30"/>
      </td>
      <td>Hybrid, Mixture of Experts</td>
    ...
    <tr>
      <td style={{ lineHeight: "1.2" }}>
        Granite-4.0-H-Micro <img src={smallPng} alt="Granite H Micro" width="20"/>
      </td>
      <td>Hybrid, Dense</td>
      <td>3B total</td>
    ...
    <tr>
      <td style={{ lineHeight: "1.2" }}>
        Granite-4.0-Micro <img src={smallPng} alt="Granite Micro" width="20"/>
      </td>
    ...
    <tr>
      <td style={{ lineHeight: "1.2" }}>
        Granite-4.0-H-1B <img src={smallPng} alt="Granite H 1B" width="16"/>
      </td>
      <td>Dense, Hybrid</td>
      <td>1.5B</td>
    ...
    <tr>
      <td style={{ lineHeight: "1.2" }}>
        Granite-4.0-1B <img src={smallPng} alt="Granite 1B Hybrid" width="16"/>
      </td>
    ...
    <tr>
      <td style={{ lineHeight: "1.2" }}>
        Granite-4.0-H-350M <img src={smallPng} alt="Granite H 350M" width="11"/>
      </td>
      <td>Dense, Hybrid</td>
      <td>350M</td>
    ...
    <tr>
      <td style={{ lineHeight: "1.2" }}>
        Granite-4.0-350M <img src={smallPng} alt="Granite 350M Hybrid" width="11"/>
      </td>
      <td>Dense, Traditional</td>
      <td>350M</td>
      <td>Alternative option for users when Mamba2 support is not yet optimized (e.g. llama.cpp, PEFT, etc)</td>
