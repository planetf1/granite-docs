...
<table>
  <thead>
    <tr>
      ...
      <th style={{ width: "180px" }}>Model Size</th>
      <th>Intended Use</th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      <td style={{ verticalAlign: "middle", paddingTop: "2px", paddingBottom: "2px", lineHeight: "1.2" }}>
        <img src="../images/granite-images/small.png" alt="Granite H Small" width="50"/> Granite-4.0-H-Small
      </td>
    ...
    <tr>
      <td style={{ verticalAlign: "middle", paddingTop: "2px", paddingBottom: "2px", lineHeight: "1.2" }}>
        <img src="../images/granite-images/small.png" alt="Granite H Tiny" width="30"/> Granite-4.0-H-Tiny
      </td>
      <td>Hybrid, Mixture of Experts</td>
    ...
    <tr>
      <td style={{ verticalAlign: "middle", paddingTop: "2px", paddingBottom: "2px", lineHeight: "1.2" }}>
        <img src="../images/granite-images/small.png" alt="Granite H Micro" width="20"/> Granite-4.0-H-Micro
      </td>
      <td>Hybrid, Dense</td>
      <td>3B total</td>
      <td>Designed for low latency and local applications, and as a building block to perform key tasks (like function calling) quickly within agentic workflows</td>
    ...
    <tr>
      <td style={{ verticalAlign: "middle", paddingTop: "2px", paddingBottom: "2px", lineHeight: "1.2" }}>
        <img src="../images/granite-images/small.png" alt="Granite Micro" width="20"/> Granite-4.0-Micro
      </td>
    ...
    <tr>
      <td style={{ verticalAlign: "middle", paddingTop: "2px", paddingBottom: "2px", lineHeight: "1.2" }}>
        <img src="../images/granite-images/small.png" alt="Granite 1B Hybrid" width="16"/> Granite-4.0-1B
      </td>
    ...
    <tr>
      <td style={{ verticalAlign: "middle", paddingTop: "2px", paddingBottom: "2px", lineHeight: "1.2" }}>
        <img src="../images/granite-images/small.png" alt="Granite H 1B" width="16"/> Granite-4.0-H-1B
      </td>
      <td>Dense, Hybrid</td>
      <td>1B</td>
    ...
    <tr>
      <td style={{ verticalAlign: "middle", paddingTop: "2px", paddingBottom: "2px", lineHeight: "1.2" }}>
        <img src="../images/granite-images/small.png" alt="Granite H 350M" width="13"/> Granite-4.0-H-350M
      </td>
      <td>Dense, Hybrid</td>
      <td>0.3B</td>
      <td>Ideal models for edge, on-device, and latency-sensitive use cases</td>
    ...
    <tr>
      <td style={{ verticalAlign: "middle", paddingTop: "2px", paddingBottom: "2px", lineHeight: "1.2" }}>
        <img src="../images/granite-images/small.png" alt="Granite 350M Hybrid" width="13"/> Granite-4.0-350M
      </td>
      <td>Dense, Traditional</td>
      <td>0.4B</td>
      <td>Alternative option for users when Mamba2 support is not yet optimized (e.g. llama.cpp, PEFT, etc)</td>
