...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style={{ lineHeight: "1.2" }}>
        Granite-4.0-H-350M <img src="../images/granite-images/small.png" alt="Granite H 350M" width="13"/>
      </td>
      <td>Dense, Hybrid</td>
      <td>0.3B</td>
      <td>Ideal models for edge, on-device, and latency-sensitive use cases</td>
    ...
    <tr>
      <td style={{ lineHeight: "1.2" }}>
        Granite-4.0-350M <img src="../images/granite-images/small.png" alt="Granite 350M Hybrid" width="13"/>
      </td>
      <td>Dense, Traditional</td>
      <td>0.4B</td>
      <td>Alternative option for users when Mamba2 support is not yet optimized (e.g. llama.cpp, PEFT, etc)</td>
