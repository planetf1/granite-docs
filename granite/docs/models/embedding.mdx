...
description: "Text embedding and reranker models that produce vector representations for semantic search, retrieval-augmented generation, and recommendation ranking."
