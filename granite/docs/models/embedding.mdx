...
description: "Granite Embedding models are dense bi-encoder models that are optimized to generate high quality text embeddings."
icon: "vector-square"
---
...
The reranker model is optional, but useful to further improve the relevance and quality of search results or recommendations. After the initial retrieval of items based on their embeddings, the reranker refines the ranking by considering additional factors and more complex criteria.
...
<CardGroup cols={2}>
  <Card
    title="Granite Embedding English r2"
    icon="arrow-right"
    href="https://huggingface.co/ibm-granite/granite-embedding-english-r2"
  >
    View model on Hugging Face
  </Card>
  <Card
    title="Granite Embedding Small English r2"
    icon="arrow-right"
    href="https://huggingface.co/ibm-granite/granite-embedding-small-english-r2"
  >
    View model on Hugging Face
  </Card>
  <Card
    title="Granite Embedding Reranker English r2"
    icon="arrow-right"
    href="https://huggingface.co/ibm-granite/granite-embedding-reranker-english-r2"
  >
    View model on Hugging Face
  </Card>
  <Card
    title="Granite Embedding 125m English r1"
    icon="arrow-right"
  ...
  <Card
    title="Granite Embedding 30m English r1"
    icon="arrow-right"
    href="https://huggingface.co/ibm-granite/granite-embedding-30m-english"
  >
    View model on Hugging Face
  ...
  <Card
    title="Granite Embedding 107m Multilingual r1"
    icon="arrow-right"
  ...
  <Card
    title="Granite Embedding 278m Multilingual r1"
    icon="arrow-right"
