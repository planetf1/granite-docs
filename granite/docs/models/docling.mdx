...
description: "End-to-end document conversion and understanding model that integrates vision and language in a single compact model, replacing traditional OCR and layout pipelines."
