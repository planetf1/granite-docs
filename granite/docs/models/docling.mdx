...
description: "Granite Docling is a multimodal Image-Text-to-Text model engineered for efficient document conversion."
icon: "n/a"
---
...
The **Granite Docling** model is designed for enterprise applications that involve end-to-end document understanding and conversion. Unlike traditional pipelines that chain together OCR, layout analysis, and post-processing, Granite Docling integrates vision and language into a single compact model (≈258M parameters), capable of parsing PDFs, slides, and scanned pages directly into structured, machine-readable formats.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Granite Docling 258m mlx"
    icon="arrow-right"
    href="https://huggingface.co/ibm-granite/granite-docling-258M-mlx"
  >
    View model on Hugging Face
  </Card>
</CardGroup>
