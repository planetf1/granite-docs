...
description: "Granite Speech is a compact and efficient speech-language model, built on top of IBM’s Granite language model and specifically designed for English automatic speech recognition (ASR)."
icon: "microphone"
---
