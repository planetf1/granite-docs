---
title: "Granite 4.1"
description: "Dense language model family in 3B, 8B, and 30B sizes with instruction-tuned variants, delivering improved tool calling, instruction following, coding, and mathematical reasoning."
...
<CardGroup cols={2}>
  <Card
    ...
    icon="arrow-right"
    href="https://huggingface.co/collections/ibm-granite/granite-41-language-models"
  >
