...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="arrow-right"
    href="https://ollama.com/gabegoodhart/granite3.3-guardian"
  >
...
1. [Definitions for Pre-Baked Criteria](#definitions-for-pre-baked-criteria)
...
[Learn more](https://ollama.com/gabegoodhart/granite3.3-guardian) about Granite Guardian on Ollama.

<CardGroup cols={2}>
  <Card
    title="Granite Guardian 3.3 8B"
    icon="download"
    href="https://ollama.com/gabegoodhart/granite3.3-guardian:8b"
  >
    Download for Ollama
  </Card>
  <Card
