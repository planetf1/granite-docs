...
<CardGroup cols={2}>
  ...
  >
    View the latest Granite Guardian model card on Hugging Face
  </Card>
  <Card
...
<CardGroup cols={2}>
  ...
  >
    Check out in-depth no-thinking examples for a variety of criteria and custom
    risks
  </Card>
  <Card
  ...
  >
    Check out in-depth thinking examples for a variety of criteria and custom
    risks
  </Card>
  <Card
